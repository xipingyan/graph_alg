...
int main(int argc, char** argv) {
    ...
    CreateEdge(graph->get_node(0), graph->get_node(2));
    CreateEdge(graph->get_node(0), graph->get_node(3));

    // Layer 2
    CreateEdge(graph->get_node(1), graph->get_node(4));
    CreateEdge(graph->get_node(1), graph->get_node(5));
    CreateEdge(graph->get_node(3), graph->get_node(6));
